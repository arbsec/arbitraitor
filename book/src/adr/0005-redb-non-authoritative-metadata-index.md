...
- `.spec/arbitraitor-adversarial-review-and-gap-analysis.md` H-05 (Metadata as authorization oracle)
- [ADR 0013](./0013-plan-bound-approval-capability.md) — Approval binds to plan, not digest alone
